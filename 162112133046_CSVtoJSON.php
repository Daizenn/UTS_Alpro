...
function csvToJson($csvUrl) {
    ...
    foreach ($csvData as $row) {
        $jsonArrayItem = []; // remove 'array' from here
        for ($i = 0; $i < count($headers); $i++) { // add initialization and condition to for loop
...
$csvUrl = 'C:/Users/Dell/Downloads/Belajar Alpro/datapribadi.csv';
